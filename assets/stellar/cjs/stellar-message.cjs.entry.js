...
class Message {
    ...
    render() {
        return __chunk_1.h(__chunk_1.Host, { class: `theme-${this.theme} ${this.shown ? "db" : "dn"}` }, __chunk_1.h("div", { class: "wrap" }, __chunk_1.h("slot", null), __chunk_1.h("button", { "aria-label": "Close", onClick: () => { this.handleClose(); } }, __chunk_1.h("stellar-asset", { name: "close" }))));
    }
