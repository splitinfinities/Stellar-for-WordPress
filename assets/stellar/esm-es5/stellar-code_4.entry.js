...
var Content = /** @class */ (function () {
    ...
    class_2.prototype.handleOpen = function () {
        this.element.scrollIntoView(true);
    };
    class_2.prototype.handleActive = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            var contents;
            var _this = this;
            return __generator(this, function (_a) {
...
var Tab = /** @class */ (function () {
    ...
    class_3.prototype.handleResize = function () {
    ...
    class_3.prototype.componentDidLoad = function () {
        ...
        document.addEventListener('pjax:send', function () {
            if (_this.open && window.location.href.includes(_this.href)) {
                _this.open = false;
                _this.removeIndicator();
            }
        });
        document.addEventListener('pjax:complete', function () {
            if (window.location.href.includes(_this.href)) {
                _this.open = true;
                _this.handleIndicatorPosition();
            }
        });
    };
    class_3.prototype.activate = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.handleClick()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    class_3.prototype.handleIndicatorPosition = function () {
    ...
    class_3.prototype.removeIndicator = function () {
    ...
    class_3.prototype.renderNotifications = function () {
        return this.notifications && h("stellar-tag", null, this.notifications);
    };
    class_3.prototype.renderTitle = function () {
        return h("span", { class: "title" }, h("slot", null));
    };
    class_3.prototype.renderButton = function () {
        var _this = this;
    ...
    class_3.prototype.renderLink = function () {
        var _this = this;
    ...
    class_3.prototype.renderAppLink = function () {
        var _this = this;
...
var Tabs = /** @class */ (function () {
    ...
    class_4.prototype.tabs = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    class_4.prototype.contents = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    class_4.prototype.blurring = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.ease.start();
                return [2 /*return*/];
    ...
    class_4.prototype.handleDark = function () {
        var _this = this;
        if (!this.tabsList || this.tabsList.length === 0) {
            this.tabsList = Array.from(this.element.querySelectorAll('stellar-tab'));
        }
