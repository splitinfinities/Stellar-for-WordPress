...
const AnimateTextCss = "stellar-animate-text{display:inline-block;position:relative;contain:content}stellar-animate-text .letter{display:inline-block}stellar-animate-text .letter{opacity:0;will-change:opacity transform}stellar-animate-text[method=\"retro\"] .letter:not(:first-of-type){position:absolute;top:calc(var(--iteration) * 7vh);left:0;right:0;color:var(--theme-complement5);z-index:calc(-1 * var(--iteration));mix-blend-mode:color}stellar-animate-text[method=\"retro\"] .letter:first-of-type{z-index:3}stellar-animate-text[method=\"retro\"] .letter:nth-of-type(2){top:0}";
...
const AnimateText = class {
    ...
    render() {
        return index.h(index.Host, { role: "text", ariaLabel: this.originalText }, index.h("slot", null), index.h("stellar-intersection", { element: this.element, multiple: true, in: this.in.bind(this), out: this.out.bind(this) }));
    }
