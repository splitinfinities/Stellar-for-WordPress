import { Component, Prop, State, Element, Method, Event, h } from "@stencil/core";
    ...
    renderCheckbox() {
        if (this.type === "checkbox" || this.type === "radio") {
            return (h("div", { class: this.focused ? "box focused" : "box" },
                h("div", { class: this.checked ? "indicator active" : "indicator" }, this.type === "checkbox" && h("ion-icon", { name: "checkmark" }))));
        }
    }
    renderRadioBlock() {
        if (this.type === "radio-block") {
