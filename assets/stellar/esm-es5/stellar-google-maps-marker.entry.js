...
var Marker = /** @class */ (function () {
    ...
    class_1.prototype.geocodeAddress = function () {
    ...
    class_1.prototype.configuration = function (map) {
        return __awaiter(this, void 0, void 0, function () {
            var latlng;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.address && (!this.lat && !this.lng))) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.geocodeAddress()];
                    case 1:
                        latlng = (_a.sent()).geometry.location;
                        return [3 /*break*/, 3];
                    case 2:
