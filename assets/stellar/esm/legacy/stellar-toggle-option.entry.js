...
var ToggleOption = /** @class */ (function () {
    ...
    ToggleOption.prototype.componentWillLoad = function () {
        this.updateRealType();
    };
    ToggleOption.prototype.componentDidLoad = function () {
    ...
    ToggleOption.prototype.updateRealType = function () {
    ...
    ToggleOption.prototype.confirm = function () {
    ...
    ToggleOption.prototype.updateSelected = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ToggleOption.prototype.onToggleChange = function (e) {
        e.stopPropagation();
        this.checked = this.input.checked;
        this.ease.start();
        this.change.emit({ element: this.element, value: this.value, checked: this.checked });
    };
    ToggleOption.prototype.onFocus = function () {
        this.focused = true;
    };
    ToggleOption.prototype.onBlur = function () {
        this.focused = false;
    };
    ToggleOption.prototype.onKeyUp = function (e) {
        if (e.key === "Enter") {
            this.input.checked = !this.input.checked;
            this.onToggleChange(e);
        }
    };
    ToggleOption.prototype.renderCheckbox = function () {
    ...
    ToggleOption.prototype.renderRadioBlock = function () {
        if (this.type === "radio-block") {
    ...
    ToggleOption.prototype.renderCheckBlock = function () {
    ...
    ToggleOption.prototype.render = function () {
        var _this = this;
        return (h("label", null, h("input", { type: "hidden", name: this.for + "[" + this.name + "]", value: this.default }), h("input", { class: "input", type: this._type, id: this.for + "_" + this.name + "_" + this.value, name: this.for + "[" + this.name + "]", checked: this.checked, value: this.value, required: this.required, onChange: function (e) { return _this.onToggleChange(e); }, onFocus: function () { return _this.onFocus(); }, onBlur: function () { return _this.onBlur(); }, onKeyUp: function (e) { return _this.onKeyUp(e); }, onClick: function (e) { e.stopPropagation(); } }), this.renderCheckbox(), ["radio", "checkbox"].indexOf(this.type) !== -1 && h("p", null, h("slot", null)), this.renderRadioBlock(), this.renderCheckBlock(), ["radio", "checkbox"].indexOf(this.type) === -1 &&
    ...
    Object.defineProperty(ToggleOption.prototype, "element", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ToggleOption, "style", {
