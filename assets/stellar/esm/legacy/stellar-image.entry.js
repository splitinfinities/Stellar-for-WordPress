...
import { j as mediumZoom, b as delay } from './chunk-a45d5d95.js';
...
var Picture = /** @class */ (function () {
    ...
    Picture.prototype.getPictureColor = function () {
        ...
        img.addEventListener('load', function () {
            ...
            properties.set({
                "--bg": "rgb(" + _this.palette[0] + ", " + _this.palette[1] + ", " + _this.palette[2] + ")"
            }, _this.element);
    ...
    Picture.prototype.render = function () {
        var _this = this;
        return (h("figure", { itemtype: "http://schema.org/ImageObject", class: this.active ? 'loaded' : '', onClick: function () {
                if (_this.zoom) {
                    _this.zoom.open();
                }
            } }, h("div", { class: "overlay" }), h("picture", null, this.renderPicture()), h("div", { class: "placeholder", style: { "background-image": "url(" + this.poster + ")" } })));
    };
