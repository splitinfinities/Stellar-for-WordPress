...
var Switch = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return (h("label", { class: "label", htmlFor: this.name, onClick: function () { _this.activate(); } }, h("input", { type: "checkbox", name: this.name, id: this.name, checked: this.checked, tabindex: "-1", onClick: function () { _this.activate(); } }), h("button", { type: "button" }, h("span", null, h("ion-icon", { name: this.checked ? "checkmark" : "close" }))), h("slot", null)));
    };
