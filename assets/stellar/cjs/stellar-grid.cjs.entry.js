...
var sortable = __chunk_2.createCommonjsModule(function (module, exports) {
...
const Sortable = __chunk_2.unwrapExports(sortable);

var swapAnimation = __chunk_2.createCommonjsModule(function (module, exports) {
(function webpackUniversalModuleDefinition(root, factory) {
	module.exports = factory();
})(window, function() {
return /******/ (function(modules) { // webpackBootstrap
...
const SwapAnimation = __chunk_2.unwrapExports(swapAnimation);
...
class Grid {
    constructor(hostRef) {
        ...
        this.orderChanged = __chunk_1.createEvent(this, "orderChanged", 7);
    }
    ...
    render() {
        return __chunk_1.h("div", { class: `grid ${this.align}` }, __chunk_1.h("slot", null));
    }
    get element() { return __chunk_1.getElement(this); }
    static get style() { return "stellar-grid,stellar-grid *,stellar-grid :after,stellar-grid :before{-webkit-box-sizing:border-box;box-sizing:border-box}stellar-grid{display:block;--grid-width:200px;--grid-gap:2rem}stellar-grid>.grid{position:relative;display:-ms-flexbox;display:flex;display:grid;-ms-flex-wrap:wrap;flex-wrap:wrap;grid-gap:var(--grid-gap);grid-template-columns:repeat(auto-fit,minmax(var(--grid-width),1fr))}stellar-grid[padding]>.grid{padding:var(--grid-gap)}stellar-grid[noresponsive]>.grid{grid-template-columns:repeat(auto-fit,minmax(var(--grid-width),1fr))}stellar-grid[noresponsive][cols=\"1\"]>.grid{grid-template-columns:1fr}stellar-grid[noresponsive][cols=\"2\"]>.grid{grid-template-columns:repeat(2,1fr)}stellar-grid[noresponsive][cols=\"3\"]>.grid{grid-template-columns:repeat(3,1fr)}stellar-grid[noresponsive][cols=\"4\"]>.grid{grid-template-columns:repeat(4,1fr)}stellar-grid[noresponsive][cols=\"5\"]>.grid{grid-template-columns:repeat(5,1fr)}stellar-grid[noresponsive][cols=\"6\"]>.grid{grid-template-columns:repeat(6,1fr)}stellar-grid>.grid .width-all{grid-column:1/-1}stellar-grid>.grid .width-2{grid-column:auto/span 2}stellar-grid>.grid .width-3{grid-column:auto/span 3}stellar-grid>.grid .width-4{grid-column:auto/span 4}stellar-grid>.grid .width-5{grid-column:auto/span 5}stellar-grid>.grid .width-6{grid-column:auto/span 6}stellar-grid>.grid .height-all{grid-row:1/-1}stellar-grid>.grid .height-2{grid-row:auto/span 2}stellar-grid>.grid .height-3{grid-row:auto/span 3}stellar-grid>.grid .height-4{grid-row:auto/span 4}stellar-grid>.grid .height-5{grid-row:auto/span 5}stellar-grid>.grid .height-6{grid-row:auto/span 6}stellar-grid .sortableCards-move{-webkit-transition:-webkit-transform .5s cubic-bezier(.22,.61,.36,1);transition:-webkit-transform .5s cubic-bezier(.22,.61,.36,1);transition:transform .5s cubic-bezier(.22,.61,.36,1);transition:transform .5s cubic-bezier(.22,.61,.36,1),-webkit-transform .5s cubic-bezier(.22,.61,.36,1);background-color:red}stellar-grid .sortableCards-enter,stellar-grid .sortableCards-leave-to{-webkit-transition:5s;transition:5s;opacity:0}stellar-grid .draggable-source--is-dragging{opacity:.6;-webkit-transform:scale(1.2);transform:scale(1.2)}stellar-grid .draggable-container--over{-webkit-animation:draggablePulseBg 1.5s cubic-bezier(.22,.61,.36,1) infinite;animation:draggablePulseBg 1.5s cubic-bezier(.22,.61,.36,1) infinite}stellar-grid .draggable-mirror{display:none}stellar-grid .draggable-source--placed{-webkit-animation:placedItem .5s cubic-bezier(.22,.61,.36,1);animation:placedItem .5s cubic-bezier(.22,.61,.36,1)}stellar-grid .sortableCards-enter-active,stellar-grid .sortableCards-leave-to{opacity:0}stellar-grid .sortableCards-leave-active{position:absolute}\@-webkit-keyframes draggablePulseBg{0%{background-color:transparent;outline:.1rem solid transparent}35%{background-color:rgba(0,0,0,.05);outline:.1rem solid rgba(0,0,0,.1)}to{background-color:transparent;outline:.1rem solid transparent}}\@keyframes draggablePulseBg{0%{background-color:transparent;outline:.1rem solid transparent}35%{background-color:rgba(0,0,0,.05);outline:.1rem solid rgba(0,0,0,.1)}to{background-color:transparent;outline:.1rem solid transparent}}\@-webkit-keyframes placedItem{0%{-webkit-transform:scale(1.065);transform:scale(1.065);-webkit-box-shadow:0 .25rem 2rem rgba(0,0,0,.25),0 .1rem .5rem rgba(0,0,0,.15);box-shadow:0 .25rem 2rem rgba(0,0,0,.25),0 .1rem .5rem rgba(0,0,0,.15)}to{-webkit-transform:scale(1);transform:scale(1);-webkit-box-shadow:0 .4rem 3rem rgba(0,0,0,.35),0 .1rem .5rem rgba(0,0,0,.2);box-shadow:0 .4rem 3rem rgba(0,0,0,.35),0 .1rem .5rem rgba(0,0,0,.2)}}\@keyframes placedItem{0%{-webkit-transform:scale(1.065);transform:scale(1.065);-webkit-box-shadow:0 .25rem 2rem rgba(0,0,0,.25),0 .1rem .5rem rgba(0,0,0,.15);box-shadow:0 .25rem 2rem rgba(0,0,0,.25),0 .1rem .5rem rgba(0,0,0,.15)}to{-webkit-transform:scale(1);transform:scale(1);-webkit-box-shadow:0 .4rem 3rem rgba(0,0,0,.35),0 .1rem .5rem rgba(0,0,0,.2);box-shadow:0 .4rem 3rem rgba(0,0,0,.35),0 .1rem .5rem rgba(0,0,0,.2)}}"; }
}
