...
import { a as createCommonjsModule, d as commonjsRequire } from './chunk-7646164d.js';
import './chunk-340b8099.js';
import { q as relPathAsAbs, r as leadingZeroIndex } from './chunk-43ad3764.js';
...
class Song {
    ...
    static get style() { return ".sc-stellar-song-h{display:block;width:100%;-ms-flex:0 0 100%;flex:0 0 100%}.sc-stellar-song-h   button.sc-stellar-song{background:none;width:100%;border:0;outline:0;-webkit-appearance:none;-moz-appearance:none;appearance:none;cursor:pointer;display:-ms-flexbox;display:flex;padding:0;-ms-flex-align:center;align-items:center;-ms-flex-pack:start;justify-content:flex-start;position:relative;overflow:hidden;border-top:1px solid var(--color-line)}.sc-stellar-song-h   button.sc-stellar-song:focus, .sc-stellar-song-h   button.sc-stellar-song:hover{background:var(--color-bg-active)}[playing].sc-stellar-song-h   button.sc-stellar-song{background:var(--color-bg-playing)!important}.sc-stellar-song-h   .index.sc-stellar-song{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;height:45px;width:55px;-ms-flex:0 0 55px;flex:0 0 55px;border-right:1px solid var(--color-line);font-size:.75rem;margin:0;margin-right:20px;text-transform:uppercase;color:var(--color-two);letter-spacing:.23em;z-index:1;font-weight:900}[playing].sc-stellar-song-h   .index.sc-stellar-song{font-size:1.5rem}.sc-stellar-song-h   img.preview-image.sc-stellar-song{width:2rem;height:2rem;display:inline-block;margin-right:10px;-webkit-transition:all .15s ease-in-out 0s;transition:all .15s ease-in-out 0s;-webkit-filter:grayscale(100%);filter:grayscale(100%);padding:0;background:#fff;border-radius:4px;z-index:1}[playing].sc-stellar-song-h   img.preview-image.sc-stellar-song{-webkit-filter:grayscale(0);filter:grayscale(0)}.sc-stellar-song-h   h2.sc-stellar-song{z-index:1;color:var(--color-four);font-size:14px;font-weight:400;margin:0;line-height:1;margin-top:-3px;white-space:nowrap}.sc-stellar-song-h   h2.sc-stellar-song   span.sc-stellar-song{color:var(--color-two)}.sc-stellar-song-h   .tracklisting.sc-stellar-song{overflow:auto;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;width:100%;height:46px}.sc-stellar-song-h   .tracklisting.sc-stellar-song:after{content:\"\";display:block;width:30px;height:30px;-ms-flex:0 0 30px;flex:0 0 30px}.sc-stellar-song-h   img.backdrop.sc-stellar-song{position:absolute;width:100%;-webkit-filter:blur(20px) grayscale(75%);filter:blur(20px) grayscale(75%);opacity:.15;z-index:0;mix-blend-mode:color}.sc-stellar-song-h   button[data-playing=true].sc-stellar-song   img.preview-image.sc-stellar-song{width:30px;height:30px;-webkit-filter:grayscale(0);filter:grayscale(0)}.sc-stellar-song-h   button[data-playing=true].sc-stellar-song   img.backdrop.sc-stellar-song{opacity:1}.sc-stellar-song-h   button[data-playing=true].sc-stellar-song   .index.sc-stellar-song, .sc-stellar-song-h   button[data-playing=true].sc-stellar-song   h2.sc-stellar-song   span.sc-stellar-song{color:var(--color-three)!important}"; }
}

export { Song as StellarSong };
