...
import { m as mediumZoom, d as delay } from './index-320c6878.js';
...
var Picture = /** @class */ (function () {
    ...
    class_1.prototype.getPictureColor = function () {
        var _this = this;
        if (window.Image) {
            var img_1 = new Image(80, 80);
            img_1.addEventListener('load', function () {
                var cf = new ColorThief();
                _this.palette = cf.getColor(img_1);
                properties.set({
