import { Component, Element, State, Prop, h, Method, Event, Watch, Host } from '@stencil/core';
...
export class Video {
    ...
    render() {
        return h(Host, null,
            h("video", { preload: this.preload, width: this.width, height: this.height, autoplay: this.autoplay, muted: this.muted, playsinline: this.playsinline, poster: this.poster, controls: this.controls },
                h("slot", null)),
    ...
    static get methods() { return {
        "videoElement": {
            "complexType": {
                "signature": "() => Promise<HTMLVideoElement>",
                "parameters": [],
                "references": {
                    "Promise": {
                        "location": "global"
