...
import { h as asTime } from './chunk-27460e3f.js';
...
var Playlist = /** @class */ (function () {
    ...
    Playlist.prototype.cycleVisualizations = function () {
    ...
    Playlist.prototype.handleSongLoaded = function (event) {
    ...
    Playlist.prototype.play = function (skipDefault) {
    ...
    Playlist.prototype.handlePlay = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.load) {
                    this.load = true;
    ...
    Playlist.prototype.render = function () {
        ...
        return (h("div", { id: "player" }, h("div", { class: "playlist-title" }, h("h6", null, this.name), h("button", { class: "playlist", onClick: function () { return _this.togglePlaylist(); } }, h("h6", { class: "list" }, h("stellar-asset", { name: "musical-notes" }), "list")), h("button", { class: "switch-view", onClick: function () { return _this.toggleAlbumArtView(); }, "data-playing": this.playing }, h("h6", { class: "list" }, (this.view === "art")
            ...
            ? "Art"
            : "Player")), h("stellar-color-picker", { val: this.visualizationColor, notransparent: true, onChange: function (e) { _this.visualizationColor = e.detail; } })), h("div", { class: "playlist-playing" }, h("button", { onClick: function () { _this.handlePlay(); }, class: "toggle-button", "data-playing": this.playing }, (this.playing)
