...
var Toggle = /** @class */ (function () {
    ...
    Toggle.prototype.validate = function () {
    ...
    Toggle.prototype.toggleChangedHandler = function (event) {
    ...
    Toggle.prototype.updateChecked = function () {
        var _this = this;
        var options = this.element.querySelectorAll('stellar-toggle-option');
        // @ts-ignore
        options.forEach(function (option) {
    ...
    Toggle.prototype.renderValidation = function () {
        if (this.error) {
            return (h("p", { class: "validation" }, this.error));
        }
    };
    Toggle.prototype.renderBlock = function () {
    ...
    Toggle.prototype.renderPlain = function () {
        return [
            h("slot", null),
