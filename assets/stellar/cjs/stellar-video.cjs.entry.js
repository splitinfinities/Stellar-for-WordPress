...
const Video = class {
    constructor(hostRef) {
        ...
        this.played = index.createEvent(this, "played", 7);
    ...
    render() {
        return index.h(index.Host, null, index.h("video", { preload: this.preload, width: this.width, height: this.height, autoplay: this.autoplay, muted: this.muted, playsinline: this.playsinline, poster: this.poster, controls: this.controls }, index.h("slot", null)), index.h("stellar-intersection", { element: this.element, multiple: true, in: this.in.bind(this), out: this.out.bind(this) }));
    }
