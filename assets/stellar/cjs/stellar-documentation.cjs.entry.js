...
const DocumentationRoot = class {
    ...
    render() {
        ...
        return (index.h(dependencies.Tunnel.Provider, { state: tunnelState }, index.h("stencil-router", null, index.h("stencil-route-switch", { scrollTopOffset: 0 }, index.h("stencil-route", { url: '/component/:name', component: 'stellar-docs-component' }), index.h("stencil-route", { url: '/:name', component: 'stellar-docs-page', exact: true }), index.h("stencil-route", { url: '/', component: 'stellar-docs-home', exact: true }), index.h("stencil-route", { component: "stellar-docs-not-found" })))));
    }
    static get style() { return DocumentationCss; }
};
