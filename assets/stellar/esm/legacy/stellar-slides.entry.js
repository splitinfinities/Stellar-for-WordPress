...
import { d as registerInstance, i as createEvent, f as h, h as Host, g as getElement } from './stellar-core-1e602ba1.js';
...
var Slides = /** @class */ (function () {
    ...
    Slides.prototype.blurStart = function () {
        if (!this.slides) {
            this.slides = Array.from(this.el.querySelectorAll('stellar-slide'));
        }
        this.ease().start();
    };
    Slides.prototype.blurEnd = function () {
        if (!this.slides) {
            this.slides = Array.from(this.el.querySelectorAll('stellar-slide'));
        }
        this.blur = -1;
        ...
        var eventOptions = {
            on: {
                slideChangeStart: function () {
                    _this.ionSlideWillChange.emit;
                },
                slideChangeEnd: function () {
                    _this.ionSlideDidChange.emit;
                },
                slideNextStart: function () {
                    _this.ionSlideNextStart.emit;
                },
                slidePrevStart: function () {
                    _this.ionSlidePrevStart.emit;
                },
                slideNextEnd: function () {
                    _this.blurEnd();
                    _this.ionSlideNextEnd.emit;
                },
                slidePrevEnd: function () {
                    _this.blurEnd();
                    _this.ionSlidePrevEnd.emit;
                },
                transitionStart: function () {
                    _this.blurStart();
                    _this.ionSlideTransitionStart.emit;
                },
                transitionEnd: function () {
                    _this.blurEnd();
                    _this.ionSlideTransitionEnd.emit;
                },
                sliderMove: function () {
                    _this.ionSlideDrag.emit;
                },
                reachBeginning: function () {
                    _this.ionSlideReachStart.emit;
                },
                reachEnd: function () {
                    _this.blurEnd();
                    _this.ionSlideReachEnd.emit;
                },
                touchStart: function () {
                    _this.ionSlideTouchStart.emit;
                },
                touchEnd: function () {
                    _this.ionSlideTouchEnd.emit;
                }
            }
        };
