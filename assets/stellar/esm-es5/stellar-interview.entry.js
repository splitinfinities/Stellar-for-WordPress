...
var Interview = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "card", onDblClick: function () { _this.handleClick(); } }, !this.visible && h("div", null, h("skeleton-img", { width: this.width, height: this.height, loading: true }), h("div", { style: { "display": "none" } }, h("slot", null))), this.visible && h("section", null, h("slot", null), h("div", { class: "transcript" }, h("slot", { name: "transcript" })), h("web-audio", { name: "interview-" + this.randomId }, h("web-audio-source", { src: this.src, name: "interview" })), h("web-audio-visualizer", { for: "interview-" + this.randomId, type: this.visualization, width: this.width, height: this.height, color: this.color }), h("button", { class: this.loading ? "loading button" : (this.playing ? "playing button" : "button"), onClick: function () { _this.handleClick(); } }, h("ion-icon", { name: this.loading ? "sync" : (this.playing ? "pause" : "play"), class: this.loading ? "animation-spin" : "" })), h("h3", null, h("stellar-unit", { class: "current", value: this.current, from: "ms", to: "s", onClick: function () { _this.handleCurrentClick(); } })), h("h3", null, h("stellar-unit", { class: "duration", value: this.duration, from: "ms", to: "s" })), h("stellar-progress", { value: this.current, max: this.duration, noease: true, blurable: false, slender: true, editable: true, onUpdate: function (e) { _this.skipTo(e.detail.value); } })), h("stellar-intersection", { element: this.element, multiple: true, in: this.in.bind(this), out: this.out.bind(this) })));
    };
    ...
    Object.defineProperty(class_1, "style", {
        get: function () { return InterviewCss; },
        enumerable: true,
        configurable: true
    });
    return class_1;
