...
class Step {
    ...
    componentWillLoad() {
        this.parent = __chunk_10.parentNodeSelector(this.element, 'stellar-steps');
    }
    handleClick() {
    ...
    render() {
        return (__chunk_1.h("button", { role: "tab", "aria-selected": this.open ? "true" : "false", "aria-setsize": this.tabCount, "aria-posinset": this.order, tabindex: "0", class: "step-button", onClick: () => this.handleClick() }, __chunk_1.h("stellar-label", null, this.renderTitle())));
    }
