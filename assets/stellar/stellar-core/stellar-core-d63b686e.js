const BUILD = {"allRenderFn":false,"cmpDidLoad":true,"cmpDidUnload":true,"cmpDidUpdate":true,"cmpDidRender":false,"cmpWillLoad":true,"cmpWillUpdate":true,"cmpWillRender":false,"connectedCallback":false,"disconnectedCallback":false,"element":false,"event":true,"hasRenderFn":true,"lifecycle":true,"hostListener":true,"hostListenerTargetWindow":true,"hostListenerTargetDocument":true,"hostListenerTargetBody":false,"hostListenerTargetParent":false,"hostListenerTarget":true,"member":true,"method":true,"mode":false,"noVdomRender":false,"observeAttribute":true,"prop":true,"propMutable":true,"reflect":true,"scoped":false,"shadowDom":true,"slot":true,"slotRelocation":true,"state":true,"style":true,"svg":true,"updatable":true,"vdomAttribute":true,"vdomClass":true,"vdomFunctional":true,"vdomKey":true,"vdomListener":true,"vdomRef":true,"vdomRender":true,"vdomStyle":true,"vdomText":true,"watchCallback":true,"taskQueue":true,"lazyLoad":true,"hydrateServerSide":false,"cssVarShim":true,"hydrateClientSide":false,"isDebug":false,"isDev":true,"lifecycleDOMEvents":true,"profile":false,"hotModuleReplacement":true,"constructibleCSS":true};
...
const supportsConstructibleStylesheets = BUILD.constructibleCSS ? /*@__PURE__*/ (() => {
    try {
        new CSSStyleSheet();
        return true;
    }
...
const disconnectedCallback = (elm) => {
    if ((plt.$flags$ & 1 /* isTmpDisconnected */) === 0) {
        ...
        const instance = (BUILD.lazyLoad || BUILD.hydrateServerSide) ? hostRef.$lazyInstance$ : elm;
...
const attachStyles = (elm, cmpMeta, mode) => {
    ...
    if ((BUILD.shadowDom || BUILD.scoped) && cmpMeta.$flags$ & 10 /* needsScopedEncapsulation */) {
...
const setValue = (ref, propName, newVal, cmpMeta) => {
    ...
    const elm = (BUILD.lazyLoad || BUILD.hydrateServerSide) ? hostRef.$hostElement$ : ref;
                ...
                if (watchMethods) {
                    ...
                    watchMethods.forEach(watchMethodName => {
                        try {
                            ...
                            (BUILD.lazyLoad || BUILD.hydrateServerSide ? hostRef.$lazyInstance$ : elm)[watchMethodName].call((BUILD.lazyLoad || BUILD.hydrateServerSide ? hostRef.$lazyInstance$ : elm), newVal, oldVal, propName);
                        }
                        catch (e) {
                            consoleError(e);
                        }
...
const initializeComponent = async (elm, hostRef, cmpMeta, hmrVersionId, Cstr) => {
    // initializeComponent
    if ((BUILD.lazyLoad || BUILD.style || BUILD.hydrateServerSide) && (hostRef.$flags$ & 256 /* hasInitializedComponent */) === 0) {
        ...
        if (BUILD.style && !Cstr.isStyleRegistered && Cstr.style) {
            ...
            if (!BUILD.hydrateServerSide && BUILD.shadowDom && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await __sc_import_stellar_core('./chunk-c152be33.js').then(m => m.scopeCss(style, scopeId, false));
            }
    ...
    lazyBundles.forEach(lazyBundle => lazyBundle[1].forEach(compactMeta => {
        ...
        const HostElement = class extends HTMLElement {
            ...
            constructor(self) {
                ...
                if (BUILD.shadowDom && !BUILD.hydrateServerSide && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
...
const proxyNative = (Cstr, compactMeta) => {
    ...
    if (BUILD.shadowDom && cmpMeta.$flags$ & 1 /* shadowDomEncapsulation */ && !supportsShadowDom) {
        cmpMeta.$flags$ |= 8 /* needsShadowDomShim */;
    }
...
const getElement = (ref) => (BUILD.lazyLoad || BUILD.hydrateServerSide) ? getHostRef(ref).$hostElement$ : ref;
...
const loadModule = (cmpMeta, hostRef, hmrVersionId) => {
    ...
    return __sc_import_stellar_core(
...
const patchBrowser = async () => {
    ...
    if (!window.customElements) {
        // @ts-ignore
        await __sc_import_stellar_core('./chunk-03b1a3a2.js');
    }
...
export { patchBrowser as a, bootstrapLazy as b, registerInstance as c, h as d, getContext as e, getElement as f, Host as g, createEvent as h };
