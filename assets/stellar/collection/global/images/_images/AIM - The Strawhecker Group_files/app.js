...
function createComponentOnReadyPrototype(win, namespace, HTMLElementPrototype) {
  ...
  })(window, document, "app","app",0,"app.core.js","app.core.pf.js","hydrated","app-footer,app-header,app-loading,app-routes,authentication-sign-in,authentication-sign-out,authentication-sign-up,authentication-signed-up,chart-card-details,chart-card-entry,chart-card-metric,chart-card-plotting,chart-create,chart-field-compound,chart-field-date,chart-field-select,chart-field-toggle,copy-wrap,csv-card-entry,csv-card-metric,csv-create,csv-field-compound,csv-field-date,csv-field-select,csv-field-toggle,ion-icon,organization-edit,report-archive,report-card,report-chart,report-create,report-single,stellar-asset,stellar-avatar,stellar-breadcrumb,stellar-breadcrumbs,stellar-button,stellar-callout,stellar-card,stellar-chart,stellar-code,stellar-code-block,stellar-content,stellar-documentation,stellar-form,stellar-grid,stellar-group,stellar-group-overflow,stellar-input,stellar-item,stellar-label,stellar-layout,stellar-markdown,stellar-modal,stellar-modal-controller,stellar-pagination,stellar-password-requirements,stellar-progress,stellar-reveal,stellar-scatter,stellar-select,stellar-switch,stellar-tab,stellar-tabs,stellar-tag,stellar-time,stellar-toggle,stellar-toggle-option,stellar-tooltip,stellar-unit,stencil-route,stencil-route-link,stencil-route-switch,stencil-router,stencil-router-redirect,upload-create,upload-history,upload-introduction,upload-invalid,upload-step-one,upload-step-three,upload-step-two,upload-validated",HTMLElement.prototype);