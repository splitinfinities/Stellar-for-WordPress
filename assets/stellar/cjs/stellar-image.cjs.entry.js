...
class Picture {
    ...
    mountZoom() {
        ...
        this.zoom = __chunk_5.mediumZoom(zoomable, {
            background: `${this.bg}`,
            scrollOffset: 1,
            margin: 30
        });
    ...
    renderPicture() {
        if (this.active) {
            return [
                ...
                __chunk_1.h("img", { src: this.sources[0].srcset, class: "final_image" })
            ];
        }
    }
    render() {
        return (__chunk_1.h("figure", { itemtype: "http://schema.org/ImageObject", class: this.active ? 'loaded' : '', onClick: () => {
                if (this.zoom) {
                    this.zoom.open();
                }
            } }, __chunk_1.h("div", { class: "overlay" }), __chunk_1.h("picture", null, this.renderPicture()), __chunk_1.h("div", { class: "placeholder", style: { "background-image": `url(${this.poster})` } })));
    }
