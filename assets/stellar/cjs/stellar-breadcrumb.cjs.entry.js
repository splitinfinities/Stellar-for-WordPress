...
const Breadcrumb = class {
    ...
    render() {
        ...
        // @ts-ignore
        return index.h(Tag, { class: "button", href: this.href, url: this.href, target: this.target, "aria-label": this.label, title: this.label, "data-disabled": this.disabled }, index.h("slot", null));
    }
