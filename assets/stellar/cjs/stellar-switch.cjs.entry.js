...
class Switch {
    ...
    render() {
        return (__chunk_1.h("label", { class: "label" }, __chunk_1.h("input", { type: "checkbox", checked: this.checked, tabindex: "-1", onClick: () => { this.activate(); } }), __chunk_1.h("button", { type: "button", onClick: () => { this.activate(); } }, __chunk_1.h("span", null, this.checked && __chunk_1.h("stellar-asset", { name: "checkmark" }), !this.checked && __chunk_1.h("stellar-asset", { name: "close" }))), __chunk_1.h("slot", null)));
    }
