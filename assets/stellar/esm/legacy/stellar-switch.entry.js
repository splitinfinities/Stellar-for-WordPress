...
var Switch = /** @class */ (function () {
    ...
    Switch.prototype.render = function () {
        var _this = this;
        return (h("label", { class: "label" }, h("input", { type: "checkbox", checked: this.checked, tabindex: "-1", onClick: function () { _this.activate(); } }), h("button", { onClick: function () { _this.activate(); } }, h("span", null, this.checked && h("stellar-asset", { name: "checkmark" }), !this.checked && h("stellar-asset", { name: "close" }))), h("slot", null)));
    };
