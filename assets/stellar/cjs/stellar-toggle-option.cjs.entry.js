...
class ToggleOption {
    constructor(hostRef) {
        ...
        this.changeToggle = __chunk_1.createEvent(this, "changeToggle", 7);
    }
    componentWillLoad() {
        this.updateRealType();
    }
    ...
    render() {
        // @ts-ignore
        return __chunk_1.h("button", { type: "button", onClick: () => this.onClick(), onKeyDown: e => this.onKeyDown(e) }, __chunk_1.h("input", { type: "hidden", name: `${this.for}[${this.name}]`, value: this.default }), __chunk_1.h("input", { class: "input", type: this._type, id: `${this.for}_${this.name}_${this.value}`, name: `${this.for}[${this.name}]`, checked: this.checked, value: this.value, required: this.required, onChange: (e) => { e.stopPropagation(); e.preventDefault(); }, onKeyDown: e => this.onKeyDown(e) }), this.renderCheckbox(), ["radio", "checkbox"].indexOf(this.type) !== -1 && __chunk_1.h("p", null, __chunk_1.h("slot", null)), this.renderRadioBlock(), this.renderCheckBlock(), ["radio", "checkbox"].indexOf(this.type) === -1 &&
