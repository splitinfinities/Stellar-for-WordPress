import { d as registerInstance, f as h, h as Host, g as getElement } from './stellar-core-1e602ba1.js';
var Message = /** @class */ (function () {
    ...
    Message.prototype.render = function () {
        var _this = this;
        return h(Host, { class: "theme-" + this.theme + " " + (this.shown ? "db" : "dn") }, h("div", { class: "wrap" }, h("slot", null), h("button", { "aria-label": "Close", onClick: function () { _this.handleClose(); } }, h("stellar-asset", { name: "close" }))));
    };
