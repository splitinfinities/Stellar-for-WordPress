    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, import('./shadow-css-5b397750.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
            case 3:
                style_1 = _a.sent();
                _a.label = 4;
            case 4:
...
var patchEsm = function () {
    ...
    if (!(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import('./css-shim.c53cae38-d1ebbffe.js').then(function () {
...
var patchBrowser = function () {
    ...
    if (importMeta !== '') {
        ...
        if (!window.customElements) {
            ...
            // @ts-ignore
            return import('./dom.5d7c41fb-b8a64ee4.js').then(function () { return opts; });
        }
    }
...
export { Host as H, patchEsm as a, bootstrapLazy as b, getMode as c, getElement as d, createEvent as e, getContext as f, getAssetPath as g, h, patchBrowser as p, registerInstance as r };
