...
import { f as mediumZoom, g as delay } from './chunk-27460e3f.js';
...
var Picture = /** @class */ (function () {
    ...
    Picture.prototype.componentWillLoad = function () {
        this.prepareSources();
        this.setBG();
        this.updateAspectRatio();
    };
    Picture.prototype.componentDidLoad = function () {
        this.addIntersectionObserver();
        this.figure = this.element.shadowRoot.querySelector('figure');
    };
    Picture.prototype.mountZoom = function () {
    ...
    Picture.prototype.handlePosterChange = function () {
        this.setBG();
    };
    Picture.prototype.handleActive = function () {
        this.setBackgroundImage();
    };
    Picture.prototype.medium = function () {
    ...
    Picture.prototype.handleImage = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Picture.prototype.addIntersectionObserver = function () {
        var _this = this;
    ...
    Picture.prototype.removeIntersectionObserver = function () {
        if (this.io) {
            this.io.disconnect();
            this.io = null;
        }
    };
    Picture.prototype.getPictureColor = function () {
        var _this = this;
    ...
    Picture.prototype.setBG = function () {
        if (this.bg === "auto") {
    ...
    Picture.prototype.prepareSources = function () {
        var sources = this.element.querySelectorAll("source");
        var sourcesArray = [];
        [].forEach.call(sources, function (source) {
            sourcesArray = sourcesArray.concat([source]);
            source.hidden = true;
        });
    ...
    Picture.prototype.setBackgroundImage = function () {
        properties.set({
            "--background-image": "url('" + (this.active ? this.large : this.poster) + "')"
        }, this.element);
    };
    Picture.prototype.updateAspectRatio = function () {
    ...
    Picture.prototype.renderPicture = function () {
        if (this.active) {
            return [
    ...
    Picture.prototype.render = function () {
        ...
        if (this.type === "picture") {
            return h("figure", { itemtype: "http://schema.org/ImageObject", class: this.active ? 'loaded' : '', onClick: function () { _this.zoom && _this.zoom.open(); } }, h("div", { class: "overlay" }), h("picture", null, this.renderPicture()), h("div", { class: "placeholder", style: { "background-image": "url(" + this.poster + ")" } }));
        }
    };
    Object.defineProperty(Picture, "assetsDirs", {
    ...
    Object.defineProperty(Picture, "watchers", {
        get: function () {
            return {
