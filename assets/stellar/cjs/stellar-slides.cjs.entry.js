...
class Slides {
    constructor(hostRef) {
        ...
        this.blur = 0;
        this.ease = () => {
            const ease = __chunk_10.blurringEase({
                end: 60,
                start: -1,
    ...
    render() {
        return __chunk_1.h(__chunk_1.Host, { tabIndex: 0 }, __chunk_1.h("stellar-blur", { class: "swiper-container", horizontal: this.blur }, __chunk_1.h("div", { class: "swiper-wrapper" }, __chunk_1.h("slot", null)), __chunk_1.h("div", { class: {
