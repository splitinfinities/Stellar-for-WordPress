...
var Card = /** @class */ (function () {
    ...
    Card.prototype.connect = function () {
    ...
    Card.prototype.attachToForm = function () {
        var _this = this;
    ...
    Card.prototype.handleResponse = function (_a) {
    ...
    Card.prototype.handleError = function (error) {
        // this.dispatchEvent(new ErrorEvent('stripe-error', {error, bubbles, composed}));
        // Show error in UI
        this.setError(error.message);
    };
    ...
    Card.prototype.prepareStripe = function () {
    ...
    Card.prototype.renderPhone = function () {
    ...
    Card.prototype.renderZip = function () {
