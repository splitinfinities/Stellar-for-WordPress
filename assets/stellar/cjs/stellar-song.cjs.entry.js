...
class Song {
    ...
    get url() {
        if (this.src.startsWith('http')) {
            ...
            return window.location.origin + __chunk_10.relPathAsAbs(this.src);
        }
        else {
    ...
    render() {
        return (__chunk_1.h("button", { onClick: () => this.play() }, __chunk_1.h("span", { class: "index" }, !this.playing && __chunk_10.leadingZeroIndex(this._index), this.playing && __chunk_1.h("stellar-asset", { name: "play" })), __chunk_1.h("div", { class: "tracklisting" }, this.artwork && __chunk_1.h("img", { src: this.picture, class: "preview-image" }), __chunk_1.h("h2", null, __chunk_1.h("span", null, this.title || "Loading..."), " / ", this.artist || "Loading...")), __chunk_1.h("img", { src: this.picture, class: "backdrop" })));
    }
