...
import { j as mediumZoom, k as delay } from './chunk-15cea9da.js';
...
class Picture {
    ...
    render() {
        return (h("figure", { itemtype: "http://schema.org/ImageObject", class: this.active ? 'loaded' : '', onClick: () => {
                if (this.zoom) {
                    this.zoom.open();
                }
