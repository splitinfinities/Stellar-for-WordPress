...
export class Steps {
    ...
    static get methods() { return {
        "steps": {
            "complexType": {
                "signature": "() => Promise<HTMLStellarStepElement[]>",
                "parameters": [],
                "references": {
                    "Promise": {
                        "location": "global"
                    },
                    "HTMLStellarStepElement": {
                        "location": "global"
                    }
                },
                "return": "Promise<HTMLStellarStepElement[]>"
            },
            "docs": {
                "text": "",
                "tags": []
        ...
        "contents": {
            "complexType": {
                "signature": "() => Promise<HTMLStellarContentElement[]>",
                "parameters": [],
                "references": {
                    "Promise": {
                        "location": "global"
                    },
                    "HTMLStellarContentElement": {
                        "location": "global"
                    }
                },
                "return": "Promise<HTMLStellarContentElement[]>"
            },
            "docs": {
                "text": "",
                "tags": []
