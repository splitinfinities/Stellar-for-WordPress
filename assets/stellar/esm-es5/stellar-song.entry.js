...
import { r as relPathAsAbs, l as leadingZeroIndex } from './index-320c6878.js';
    ...
    return function f(p, q, m) {
        ...
        1: [function (f, p, q) { }, {}], 2: [function (f, p, q) { p.exports = XMLHttpRequest; }, {}], 3: [function (f, p, q) {
                ...
                f = function (e) {
                    ...
                    m(d, e);
                    l(d, [{ key: "init", value: function (c) { setTimeout(c.onSuccess, 0); } }, { key: "loadRange", value: function (c, a) { setTimeout(a.onSuccess, 0); } }, { key: "getByteAt", value: function (c) {
                                if (c >= this._array.length)
                                    throw Error("Offset " + c + " hasn't been loaded yet.");
                ...
                f = function (d) {
                    ...
                    m(c, d);
                    l(c, [{ key: "_init", value: function (a) { this._size = this._blob.size; setTimeout(a.onSuccess, 1); } }, {
                ...
                f = function () {
                    ...
                    m(f, [{
                            ...
                            value: function (e, d, c) { return e.slice ? e.slice(d, c) : e.subarray(d, c); }
                                ...
                                if (-1 === b)
                                    return { startIx: -1, endIx: -1, insertIx: h };
                ...
                f = function (a) {
                    ...
                    m(b, a);
                    l(b, [{ key: "_loadData", value: function (a, b) { var h = this; a.loadRange([4, 7], { onSuccess: function () { h._loadBlock(a, 4, b); } }); } }, {
                ...
                f = function (d) {
                    ...
                    m(c, d);
                    l(c, [{ key: "_loadData", value: function (a, b) { var d = a.getSize(); a.loadRange([d - 128, d - 1], b); } }, {
                            key: "_parseData", value: function (a, b) {
                ...
                f = function () {
                    ...
                    e(d, null, [{ key: "getFrameReaderFunction", value: function (a) { return a in b ? b[a] : "T" === a[0] ? b["T*"] : "W" === a[0] ? b["W*"] : null; } }, {
                        ...
                        }, { key: "_getFrameDescription", value: function (b) { return b in a ? a[b] : "Unknown"; } }, { key: "getUnsyncFileReader", value: function (a, b, d) {
                                a = a.getBytesAt(b, d);
                    ...
                    l(a, [{ key: "_loadData", value: function (a, c) { a.loadRange([6, 9], { onSuccess: function () { a.loadRange([0, 10 + a.getSynchsafeInteger32At(6) - 1], c); }, onError: c.onError }); } }, {
                            ...
                            value: function (a, c) {
                                for (var b = 0, d; d = c[b]; b++)
                                    if (d in a)
                                        return a = a[d] instanceof Array ? a[d][0] : a[d], a.data;
                            }
                ...
                f = function (a) {
                    ...
                    m(b, a);
                    l(b, [{ key: "_loadData", value: function (a, b) { var c = this; a.loadRange([0, 16], { onSuccess: function () { c._loadAtom(a, 0, "", b); }, onError: b.onError }); } }, {
                ...
                f = function () {
                    ...
                    m(e, [{ key: "init", value: function (d) {
                                var c = this;
                                if (this._isInitialized)
                                    setTimeout(d.onSuccess, 1);
                                else
                                    return this._init({ onSuccess: function () { c._isInitialized = !0; d.onSuccess(); }, onError: d.onError });
                        ...
                        }, { key: "getByteAt", value: function (d) { throw Error("Must implement getByteAt function"); } }, { key: "getBytesAt", value: function (d, c) {
                                for (var a = Array(c), b = 0; b < c; b++)
                                    a[b] = this.getByteAt(d + b);
                                return a;
                            } }, { key: "isBitSetAt", value: function (d, c) { return 0 != (this.getByteAt(d) & 1 << c); } }, { key: "getSByteAt", value: function (d) { d = this.getByteAt(d); return 127 < d ? d - 256 : d; } }, {
                    ...
                    m(f, [{ key: "setTagsToRead", value: function (e) { this._tags = e; return this; } }, {
                            key: "read", value: function (e) {
                                ...
                                this._mediaFileReader.init({
                                    onSuccess: function () {
                                        d._loadData(d._mediaFileReader, { onSuccess: function () {
                                                try {
                ...
                q = function (d) {
                    ...
                    l(c, [{ key: "_init", value: function (a) { c._config.avoidHeadRequests ? this._fetchSizeWithGetRequest(a) : this._fetchSizeWithHeadRequest(a); } }, {
                            ...
                            key: "_makeXHRRequest", value: function (a, b, d) {
                                ...
                                var f = function () {
                                    if (200 === e.status || 206 === e.status)
                                        ...
                                        d.onError({ type: "xhr", info: "Unexpected HTTP status " + e.status + ".", xhr: e });
                                    e = null;
                                };
                                "undefined" !==
                                    typeof e.onload ? (e.onload = f, e.onerror = function () {
                                    if (d.onError)
                                        d.onError({ type: "xhr", info: "Generic XHR error, check xhr object.", xhr: e });
                                }) : e.onreadystatechange = function () { 4 === e.readyState && f(); };
                        ...
                        }, { key: "_setRequestHeader", value: function (a, b, d) { 0 > c._config.disallowedXhrHeaders.indexOf(b.toLowerCase()) && a.setRequestHeader(b, d); } }, { key: "_hasResponseHeader", value: function (a, b) {
                            ...
                            key: "_getResponseHeader", value: function (a, b) { return this._hasResponseHeader(a, b) ? a.getResponseHeader(b) : null; }
...
var SongCss = ":host{display:block;width:100%;-ms-flex:0 0 100%;flex:0 0 100%;contain:content}:host button{background:none;width:100%;border:0;outline:0;-webkit-appearance:none;-moz-appearance:none;appearance:none;cursor:pointer;display:-ms-flexbox;display:flex;padding:0;-ms-flex-align:center;align-items:center;-ms-flex-pack:start;justify-content:flex-start;position:relative;overflow:hidden;border-top:1px solid var(--color-line)}:host button:hover,:host button:focus{background:var(--color-bg-active)}:host([playing]) button{background:var(--color-bg-playing) !important}:host .index{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;height:45px;width:55px;-ms-flex:0 0 55px;flex:0 0 55px;border-right:1px solid var(--color-line);font-size:0.75rem;margin:0;margin-right:20px;text-transform:uppercase;color:var(--color-two);letter-spacing:.23em;z-index:1;font-weight:900}:host([playing]) .index{font-size:1.5rem}:host img.preview-image{width:2rem;height:2rem;display:inline-block;margin-right:10px;-webkit-transition:all .15s ease-in-out 0s;transition:all .15s ease-in-out 0s;-webkit-filter:grayscale(100%);filter:grayscale(100%);padding:0;background:white;border-radius:4px;z-index:1}:host([playing]) img.preview-image{-webkit-filter:grayscale(0%);filter:grayscale(0%)}:host h2{z-index:1;color:var(--color-four);font-size:14px;font-weight:400;margin:0;line-height:1;margin-top:-3px;white-space:nowrap}:host h2 span{color:var(--color-two)}:host .tracklisting{overflow:auto;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;width:100%;height:46px}:host .tracklisting::after{content:\"\";display:block;width:30px;height:30px;-ms-flex:0 0 30px;flex:0 0 30px}:host img.backdrop{position:absolute;width:100%;-webkit-filter:blur(20px) grayscale(75%);filter:blur(20px) grayscale(75%);opacity:0.15;z-index:0;mix-blend-mode:color}:host button[data-playing=\"true\"] img.preview-image{width:30px;height:30px;-webkit-filter:grayscale(0%);filter:grayscale(0%)}:host button[data-playing=\"true\"] img.backdrop{opacity:1}:host button[data-playing=\"true\"] h2 span,:host button[data-playing=\"true\"] .index{color:var(--color-three) !important}";
var Song = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return (h("button", { onClick: function () { return _this.play(); } }, h("span", { class: "index" }, !this.playing && leadingZeroIndex(this._index), this.playing && h("ion-icon", { name: "play" })), h("div", { class: "tracklisting" }, this.artwork && h("img", { src: this.picture, class: "preview-image" }), h("h2", null, h("span", null, this.title || "Loading..."), " / ", this.artist || "Loading...")), h("img", { src: this.picture, class: "backdrop" })));
    };
