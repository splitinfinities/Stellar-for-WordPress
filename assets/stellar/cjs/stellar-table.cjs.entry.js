...
const Table = class {
    ...
    render() {
        return [
            this.chart && index.h("stellar-chart", { for: this.name }),
            this.upgrade ? index.h("complete-table", { name: this.name }, index.h("slot", null)) : index.h("slot", null)
        ];
    }
