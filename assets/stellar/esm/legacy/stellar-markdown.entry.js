...
var Markdown = /** @class */ (function () {
    function Markdown(hostRef) {
        registerInstance(this, hostRef);
        this.flavor = "vanilla";
        this.editable = false;
        this.showdown = new showdown.Converter();
    }
    Markdown.prototype.componentWillLoad = function () {
    ...
    Markdown.prototype.onCodeStringChange = function () {
        this.convert();
    };
    Markdown.prototype.onSrcChange = function () {
        this.convert();
    };
    Markdown.prototype.convert = function () {
        if (this.src) {
            this.fetchMarkdown();
        }
    ...
    Markdown.prototype.convertMarkdown = function () {
    ...
    Markdown.prototype.replaceAll = function (str, find, replace) {
        return str.replace(new RegExp(find, 'g'), replace);
    };
    Markdown.prototype.fetchMarkdown = function () {
    ...
    Markdown.prototype.render = function () {
        var _this = this;
        if (this.editable) {
            return h("stellar-card", null, h("section", null, h("copy-wrap", { full: true, class: "wrap" }, h("div", { innerHTML: this.converted }))), h("footer", { class: "bg-theme-base0" }, h("stellar-input", { type: "textarea", default: this.codeString, onChange: function (e) { _this.codeString = e.detail; _this.convert(); } })));
        }
        else {
            return h("copy-wrap", { full: true, class: "wrap" }, h("div", { innerHTML: this.converted }));
        }
    };
    Object.defineProperty(Markdown.prototype, "element", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Markdown, "watchers", {
        get: function () {
            return {
    ...
    Object.defineProperty(Markdown, "style", {
...
export { Markdown as stellar_markdown };
