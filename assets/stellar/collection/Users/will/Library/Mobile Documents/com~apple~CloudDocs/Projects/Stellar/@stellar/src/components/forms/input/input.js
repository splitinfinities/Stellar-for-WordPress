import { Component, Element, Prop, State, Listen, Method, Event, Watch, h } from '@stencil/core';
...
export class Input {
    ...
    renderColorPicker() {
        if (this.type === "color") {
            return (h("copy-wrap", { class: "color-picker", align: "center", "data-invert": this.validateDarkColor() },
                h("stellar-label", { for: "input", size: this.size }, this.value)));
        }
    }
    renderSearch() {
        if (this.type === "search") {
    ...
    renderDatePicker() {
        if (isDatePicker(this.type)) {
            return (h("div", { class: "relative" },
                ...
                h("input", { class: "input", ref: (el) => this.input = el, id: "input", type: "text", name: this.name, placeholder: this.placeholder, required: this.required, maxlength: this.maxlength, autofocus: this.autofocus, readonly: this.readonly, disabled: this.disabled, min: this.min, max: this.max, step: this.step, autocomplete: this.autocomplete || this.type, value: this.value, onInput: () => this.handleInput(), onChange: () => this.handleChange(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur(), onKeyDown: (event) => { this.handleKeyDownIncrement(event); this.handleKeyDownDecrement(event); } })));
        }
    }
    renderInput() {
        ...
        if (this.type === "file") {
            return (h("div", { class: "file-wrapper" },
                h("div", { class: "upload-card" },
                    h("section", null,
                        h("input", { class: "input", ref: (el) => this.input = el, id: "input", type: this.type, name: this.name, placeholder: this.placeholder, required: this.required, maxlength: this.maxlength, autofocus: this.autofocus, readonly: this.readonly, disabled: this.disabled, onClick: (e) => { e.stopPropagation(); }, onInput: () => this.handleInput(), onChange: () => this.handleChange(), multiple: this.multiple, accept: this.accept, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }),
                        this._fileLabel && h("h3", null, this._fileLabel),
                        h("h4", null,
                            h("ion-icon", { name: this._fileLabel ? "create" : "add-circle", class: "" }),
                            this.placeholder),
        ...
        return (h("div", { class: "wrapper" },
            h("label", null,
                ...
                h("div", { class: "content" },
                    ...
                    this.showCapsLock && this.capsLock && h("div", { class: "caps-lock" },
                        h("stellar-label", { size: this.size }, "Caps Lock"),
                        h("ion-icon", { name: "arrow-dropup-circle" })),
    ...
    static get properties() { return {
        ...
        "autocomplete": {
            ...
            "mutable": false,
            "complexType": {
                "original": "\"name\" | \"honorific-prefix\" | \"given-name\" | \"additional-name\" | \"family-name\" | \"honorific-suffix\" | \"nickname\" | \"username\" | \"current-password\" | \"new-password\" | \"one-time-code\" | \"organization-title\" | \"organization\" | \"street-address\" | \"address-line1\" | \"address-line2\" | \"address-line3\" | \"address-level4\" | \"address-level3\" | \"address-level2\" | \"address-level1\" | \"country\" | \"country-name\" | \"postal-code\" | \"cc-name\" | \"cc-given-name\" | \"cc-additional-name\" | \"cc-family-name\" | \"cc-number\" | \"cc-exp\" | \"cc-exp-month\" | \"cc-exp-year\" | \"cc-csc\" | \"cc-type\" | \"transaction-currency\" | \"transaction-amount\" | \"language\" | \"bday\" | \"bday-day\" | \"bday-month\" | \"bday-year\" | \"sex\" | \"url\" | \"photo\"",
                "resolved": "\"name\" | \"honorific-prefix\" | \"given-name\" | \"additional-name\" | \"family-name\" | \"honorific-suffix\" | \"nickname\" | \"username\" | \"current-password\" | \"new-password\" | \"one-time-code\" | \"organization-title\" | \"organization\" | \"street-address\" | \"address-line1\" | \"address-line2\" | \"address-line3\" | \"address-level4\" | \"address-level3\" | \"address-level2\" | \"address-level1\" | \"country\" | \"country-name\" | \"postal-code\" | \"cc-name\" | \"cc-given-name\" | \"cc-additional-name\" | \"cc-family-name\" | \"cc-number\" | \"cc-exp\" | \"cc-exp-month\" | \"cc-exp-year\" | \"cc-csc\" | \"cc-type\" | \"transaction-currency\" | \"transaction-amount\" | \"language\" | \"bday\" | \"bday-day\" | \"bday-month\" | \"bday-year\" | \"sex\" | \"url\" | \"photo\"",
                "references": {}
            },
            "required": false,
            "optional": false,
