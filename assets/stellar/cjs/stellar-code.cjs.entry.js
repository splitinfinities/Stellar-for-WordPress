...
var prismNormalizeWhitespace = __chunk_2.createCommonjsModule(function (module) {
(function() {
...
class Code {
    ...
    async clipboard() {
        ...
        __chunk_13.ezClipboard.copyPlain(copyText);
    }
    async setCode(code) {
        this.code = code;
    }
    ...
    renderPreview() {
        return __chunk_1.h("section", { class: "preview flush" }, __chunk_1.h("div", { class: "result", innerHTML: this.raw }));
    }
    renderCode() {
        return __chunk_1.h("pre", { "aria-label": `The ${this.language} code`, tabindex: 0 }, __chunk_1.h("code", { class: `language-${this.language}`, innerHTML: this.code }), __chunk_1.h("div", { class: "hidden" }, __chunk_1.h("slot", null, __chunk_1.h("template", null, __chunk_1.h("p", null, "There's no code here!")))));
    }
    render() {
        if (this.simple) {
