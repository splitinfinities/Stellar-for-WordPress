...
const __chunk_5 = require('./chunk-c9bb88e7.js');
...
class Breadcrumb {
    ...
    render() {
        ...
        // @ts-ignore
        return __chunk_1.h(Tag, { class: "button", href: this.href, url: this.href, target: this.target, "aria-label": this.label, title: this.label, "data-disabled": this.disabled }, __chunk_1.h("slot", null));
    }
    get element() { return __chunk_1.getElement(this); }
...
class Breadcrumbs {
    ...
    render() {
        return (__chunk_1.h("div", { id: "breadcumb_wrapper", class: "breadcrumbs" }, __chunk_1.h("div", { class: "flush-left" }), __chunk_1.h("stellar-breadcrumb", { first: true, tag: this.tag }, __chunk_1.h("stellar-asset", { id: "icon", name: this.icon, src: this.icon_src, color: this.color }), __chunk_1.h("stellar-label", null, this.label)), __chunk_1.h("slot", null), __chunk_1.h("div", { class: "flush" })));
    }
    get el() { return __chunk_1.getElement(this); }
...
function injectHistory(Component) {
    __chunk_4.ActiveRouter.injectProps(Component, ['history', 'location']);
}
...
class Item {
    constructor(hostRef) {
        ...
        this.mounted = __chunk_1.createEvent(this, "mounted", 7);
        this.focusChanged = __chunk_1.createEvent(this, "focusChanged", 7);
        this.blurChanged = __chunk_1.createEvent(this, "blurChanged", 7);
    }
    componentWillLoad() {
    ...
    render() {
        return (__chunk_1.h(this.type, { class: "button", type: "button", href: this.href, url: this.href, tabindex: "0", value: this.value, title: this.label, onClick: (e) => this.handleClick(e), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() }, __chunk_1.h("slot", null), (this.selected || this.multiple) && __chunk_1.h("stellar-asset", { class: this.classes(), name: "checkmark", block: true })));
    }
    get element() { return __chunk_1.getElement(this); }
...
var pluralize = __chunk_2.createCommonjsModule(function (module, exports) {
/* global define */

(function (root, pluralize) {
  /* istanbul ignore else */
  if (typeof __chunk_2.commonjsRequire === 'function' && 'object' === 'object' && 'object' === 'object') {
    // Node.
...
class Select {
    ...
    renderLabel() {
        if (this.label) {
            return __chunk_1.h("div", { class: "label-wrapper" }, __chunk_1.h("stellar-label", { size: this.size, onClick: () => { this.focusFirstItem(); } }, this.label), this.renderEmptyButton());
        }
    }
    renderErrors() {
    ...
    renderEmptyButton() {
        return this.multiple && this.value && this.value.length > 0 && __chunk_1.h("stellar-button", { class: "clear-button", tag: "button", size: "tiny", ghost: true, onClick: (e) => { e.stopPropagation(); this.clearValue(); } }, __chunk_1.h("stellar-asset", { name: "close", class: "fs4 mr1" }), this.clear_confirm ? `Clear ${this.value.length} selections?` : `Clear`);
    }
    render() {
...
class Tooltip {
    ...
    render() {
        return (__chunk_1.h("div", { class: "wrap" }, __chunk_1.h("div", { class: "after" }), __chunk_1.h("slot", null)));
    }
    get element() { return __chunk_1.getElement(this); }
...
class RouteLink {
    ...
    handleClick(e) {
        if (__chunk_8.isModifiedEvent(e) || !this.history || !this.url || !this.root) {
            return;
        }
        e.preventDefault();
...
exports.stellar_tooltip = Tooltip;
