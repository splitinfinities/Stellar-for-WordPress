...
const Code = class {
    ...
    async clipboard() {
        ...
        index$2.ezClipboard.copyPlain(copyText);
    }
    async setCode(code) {
        this.code = code;
    }
    ...
    renderPreview() {
        return index.h("section", { class: "preview flush" }, index.h("div", { class: "result", innerHTML: this.raw }));
    }
    renderCode() {
        return index.h("pre", { "aria-label": `The ${this.language} code`, tabindex: 0 }, index.h("code", { class: `language-${this.language}`, innerHTML: this.code }), index.h("div", { class: "hidden" }, index.h("slot", null, index.h("template", null, index.h("p", null, "There's no code here!")))));
    }
    render() {
        if (this.simple) {
            ...
            return index.h("stellar-card", { shadow: "light", padding: "small" }, this.feature && index.h("header", null, index.h("slot", { name: "feature" }), index.h("slot", { name: "property" })), this.preview && this.renderPreview(), index.h("footer", { class: "code" }, this.renderCode()));
        }
    }
...
theme.Tunnel.injectProps(Code, ['dark']);
...
const Content = class {
    ...
    render() {
        return (index.h("div", { class: "wrap", role: "tabpanel", "aria-hidden": !this.open ? "true" : "false" }, index.h("slot", null)));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
        "open": ["handleOpen"]
...
const Tab = class {
    constructor(hostRef) {
        ...
        */
        ...
        this.target = '_self';
        this.vertical = false;
        this.contentChange = index.createEvent(this, "contentChange", 7);
    }
    componentWillLoad() {
    ...
    renderNotifications() {
        return this.notifications && index.h("stellar-tag", null, this.notifications);
    }
    renderTitle() {
        return index.h("span", { class: "title" }, index.h("slot", null));
    }
    renderButton() {
        return (index.h("button", { role: "tab", type: "button", disabled: this.disabled, "aria-selected": this.open ? "true" : "false", "aria-setsize": this.tabCount, "aria-posinset": this.order, tabindex: "0", class: "tab-button", onClick: (e) => this.handleClick(e) }, this.renderNotifications(), this.renderTitle()));
    }
    renderLink() {
        return (index.h("a", { role: "tab", href: this.href, target: this.target, class: "tab-button", "data-disabled": this.disabled, onClick: (e) => { this.handleClick(e); } }, this.renderNotifications(), this.renderTitle()));
    }
    renderAppLink() {
        return (index.h("stencil-route-link", { role: "tab", url: this.href, anchorClass: "tab-button", "data-disabled": this.disabled, onClick: (e) => { this.handleClick(e); } }, this.renderNotifications(), this.renderTitle()));
    }
    render() {
        return index.h("div", { class: "tab-wrap" }, this.tag === "button" && this.renderButton(), this.tag === "link" && this.renderLink(), this.tag === "route-link" && this.renderAppLink(), this.tag === "pjax" && this.renderButton());
    }
    get element() { return index.getElement(this); }
...
const Tabs = class {
    ...
    render() {
        return (index.h("div", { class: "tab-wrap" }, index.h("div", { class: "tab-list", role: "tablist" }, index.h("slot", null), index.h("stellar-blur", { horizontal: !this.vertical ? this.blur : 0, vertical: this.vertical ? this.blur : 0 }, index.h("div", { class: "indicator" })))));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
        "dark": ["handleDark"]
