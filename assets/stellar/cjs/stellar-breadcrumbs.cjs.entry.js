...
const Breadcrumbs = class {
    ...
    render() {
        return (index.h("div", { id: "breadcumb_wrapper", class: "breadcrumbs" }, index.h("div", { class: "flush-left" }), index.h("stellar-breadcrumb", { first: true, tag: this.tag }, index.h("ion-icon", { id: "icon", name: this.icon, src: this.icon_src, color: this.color }), index.h("stellar-label", { size: this.size }, this.label)), index.h("slot", null), index.h("div", { class: "flush" })));
    }
