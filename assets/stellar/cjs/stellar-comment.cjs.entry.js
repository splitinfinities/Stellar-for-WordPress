...
class Comment {
    ...
    render() {
        return (__chunk_1.h("div", { class: `comment ${this.empty ? "empty" : ""}`, "aria-label": `Comment by ${this.name}: ${this.content}`, tabindex: 0 }, __chunk_1.h("div", { class: "content" }, __chunk_1.h("slot", { name: "avatar" }), __chunk_1.h("slot", { name: "content" })), __chunk_1.h("div", { class: `thread`, "aria-label": `In reply to  ${this.name} saying ${this.content}` }, __chunk_1.h("slot", null))));
    }
