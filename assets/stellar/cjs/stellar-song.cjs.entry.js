        ...
        1: [function (f, p, q) { }, {}], 2: [function (f, p, q) { p.exports = XMLHttpRequest; }, {}], 3: [function (f, p, q) {
                ...
                f = function (e) {
                    ...
                    l(d, [{ key: "init", value: function (c) { setTimeout(c.onSuccess, 0); } }, { key: "loadRange", value: function (c, a) { setTimeout(a.onSuccess, 0); } }, { key: "getByteAt", value: function (c) { if (c >= this._array.length)
                                throw Error("Offset " + c + " hasn't been loaded yet."); return this._array[c]; } }], [{
                ...
                f = function () {
                    ...
                    m(f, [{
                            ...
                            value: function (e, d, c) { return e.slice ? e.slice(d, c) : e.subarray(d, c); }
                        }, { key: "_getChunkRange", value: function (e, d) { for (var c, a, b = -1, g = -1, h = 0, k = 0; k < this._fileData.length; k++, h = k) {
                                ...
                                ; -1 === g && (g = b); return { startIx: b, endIx: g }; } }, {
                            key: "hasDataRange",
                        ...
                        }, { key: "getByteAt", value: function (e) { for (var d, c = 0; c < this._fileData.length; c++) {
                ...
                f = function () {
                    ...
                    m(e, [{ key: "init", value: function (d) { var c = this; if (this._isInitialized)
                                ...
                                return this._init({ onSuccess: function () { c._isInitialized = !0; d.onSuccess(); }, onError: d.onError }); } }, { key: "_init", value: function (d) { throw Error("Must implement init function"); } }, { key: "loadRange", value: function (d, c) { throw Error("Must implement loadRange function"); } }, {
                            key: "getSize", value: function () {
                                ...
                                a[b] = this.getByteAt(d + b); return a; } }, { key: "isBitSetAt", value: function (d, c) { return 0 != (this.getByteAt(d) & 1 << c); } }, { key: "getSByteAt", value: function (d) { d = this.getByteAt(d); return 127 < d ? d - 256 : d; } }, {
                ...
                q = function (d) {
                    ...
                    l(c, [{ key: "_init", value: function (a) { c._config.avoidHeadRequests ? this._fetchSizeWithGetRequest(a) : this._fetchSizeWithHeadRequest(a); } }, {
                            ...
                            key: "_makeXHRRequest", value: function (a, b, d) {
                                ...
                                c[d] = a[d].split(":")[0].toLowerCase(); return 0 <= c.indexOf(b.toLowerCase()); } }, {
                    ...
                    e(a, [{ key: "setTagsToRead", value: function (a) { this._tagsToRead = a; return this; } }, { key: "setFileReader", value: function (a) { this._fileReader = a; return this; } }, { key: "setTagReader", value: function (a) { this._tagReader = a; return this; } }, {
                            key: "read", value: function (a) {
                                ...
                                if (k[a].canReadFile(this._file))
                                    return k[a]; throw Error("No suitable file reader found for " + this._file); } }, {
...
const Song = class {
    ...
    get url() {
        if (this.src.startsWith('http')) {
            ...
            return window.location.origin + index$1$1.relPathAsAbs(this.src);
        }
        else {
    ...
    render() {
        return (index.h("button", { onClick: () => this.play() }, index.h("span", { class: "index" }, !this.playing && index$1$1.leadingZeroIndex(this._index), this.playing && index.h("ion-icon", { name: "play" })), index.h("div", { class: "tracklisting" }, this.artwork && index.h("img", { src: this.picture, class: "preview-image" }), index.h("h2", null, index.h("span", null, this.title || "Loading..."), " / ", this.artist || "Loading...")), index.h("img", { src: this.picture, class: "backdrop" })));
    }
    static get assetsDirs() { return ["./vendor"]; }
    get element() { return index.getElement(this); }
    static get style() { return SongCss; }
};
