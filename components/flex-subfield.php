<?php global $item; ?>
<?php $content = get_field("content_the_content"); ?>

<?php if (!$content): ?>
    <?php $content = get_sub_field('content_the_content'); ?>
<?php endif; ?>

<?php foreach ($content as $key=>$item): ?>
    <?php $sticky = $item['sticky'] && !get_sub_field('parallax') ? 'sticky top-1 bottom-1' : ''; ?>
