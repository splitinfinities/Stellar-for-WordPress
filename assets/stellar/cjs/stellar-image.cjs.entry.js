...
class Picture {
    ...
    mountZoom() {
        ...
        this.zoom = __chunk_10.mediumZoom(zoomable, {
            background: `${this.bg}`,
            scrollOffset: 1,
            margin: 30
        });
    ...
    renderPicture() {
        if (this.active) {
            return [
                this.sources.map((source) => __chunk_1.h("source", { srcSet: source.srcset, media: source.media ? source.media : false })),
                __chunk_1.h("img", { src: this.large, class: "final_image" })
            ];
        }
    }
    render() {
        if (this.type === "picture") {
            return __chunk_1.h("figure", { itemtype: "http://schema.org/ImageObject", class: this.active ? 'loaded' : '', onClick: () => { this.zoom && this.zoom.open(); } }, __chunk_1.h("div", { class: "overlay" }), __chunk_1.h("picture", null, this.renderPicture()), __chunk_1.h("div", { class: "placeholder", style: { "background-image": `url(${this.poster})` } }));
        }
    }
