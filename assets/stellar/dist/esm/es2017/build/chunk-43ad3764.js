...
import { a as createCommonjsModule, c as unwrapExports, b as commonjsGlobal } from './chunk-7646164d.js';
...
var calculateValue = function calculateValue(startValue, endValue, ease, duration, progress) {
  ...
  if (typeof startValue === 'string' || typeof endValue === 'string') {
    var _CSS_UNIT$match = CSS_UNIT.match(startValue),
        start = _CSS_UNIT$match[0],
        unit = _CSS_UNIT$match[1];

    var _CSS_UNIT$match2 = CSS_UNIT.match(endValue),
        end = _CSS_UNIT$match2[0];
  }
...
var Tween = function () {
  function Tween(_ref) {
    var start = _ref.start,
        ...
        _ref$ease = _ref.ease,
        ease = _ref$ease === undefined ? Linear : _ref$ease,
  ...
  Tween.prototype.tick = function tick() {
...
const leadingZeroIndex = function (index$$1) {
    var s = index$$1 + "";
    while (s.length < 2)
        s = "0" + s;
    return s;
