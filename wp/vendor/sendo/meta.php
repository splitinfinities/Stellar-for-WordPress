...
printf('<meta id="theme-color" name="theme-color" content="%s">', get_field('brand_primary_color', 'option'));
printf('<meta name="msapplication-navbutton-color" content="%s" />', get_field('brand_primary_color', 'option'));
