...
var Tab = /** @class */ (function () {
    ...
    Tab.prototype.render = function () {
        var _this = this;
        return h("div", { class: "tab-wrap" }, h("button", { role: "tab", type: "button", "aria-selected": this.open ? "true" : "false", "aria-setsize": this.tabCount, "aria-posinset": this.order, tabindex: "0", class: "tab-button", onClick: function (e) { return _this.handleClick(e); } }, this.renderNotifications(), this.renderTitle()));
    };
