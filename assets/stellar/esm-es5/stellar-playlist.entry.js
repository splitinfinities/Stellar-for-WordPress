...
var Playlist = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return (h("div", { id: "player" }, h("div", { class: "playlist-title" }, h("h6", null, this.name), h("button", { class: "playlist", onClick: function () { return _this.togglePlaylist(); } }, h("h6", { class: "list" }, h("ion-icon", { name: "musical-notes" }), "list")), h("button", { class: "switch-view", onClick: function () { return _this.toggleAlbumArtView(); }, "data-playing": this.playing }, h("h6", { class: "list" }, (this.view === "art")
            ...
            : h("ion-icon", { name: "play" })), !this.load && h("stellar-button", { tag: "button", size: "tiny", onClick: function () { _this.load = true; _this.load_songs.emit({}); } }, "Load ", this.name || "this playlist"), this.load && h("div", { class: "playlist-playing-details" }, h("h2", null, this.currentTrack.title || 'Loading...'), h("h3", null, this.currentTrack.artist || 'One Sec...')), this.load &&
            h("div", { class: "playlist-playing-image" }, this.loading && h("stellar-progress", { indeterminate: true }), !this.loading && (this.currentTrack.picture !== undefined) && h("img", { src: this.currentTrack.picture, onClick: function () { return _this.toggleAlbumArtView(); } })), (!this.load && this.currentTrack.picture === undefined) && h("skeleton-img", { width: 1024, height: 1024, block: true, loading: true }), h("web-audio-visualizer", { type: this.visualizationType, color: this.visualizationColor, onClick: function () { _this.cycleVisualizations(); }, width: 1024, height: this.view === "art" ? 1024 : 256 }), h("div", { class: "playlist-progress " + (this.load ? "load" : "noload") }, h("h6", { id: "currentTime" }, this.currentTime), h("h6", { id: "totalTime" }, this.duration), h("progress", { id: "progress", max: "100", value: this.progressValue }))), h("div", { id: "controls", class: "controls" }, h("button", { onClick: function () { return _this.previous(); }, class: "button previous" }, h("ion-icon", { name: "skip-backward" })), h("button", { onClick: function () { return _this.next(); }, class: "button next" }, h("ion-icon", { name: "skip-forward" }))), h("audio", { id: "playlist-audio", preload: "auto", tabindex: "0", controls: true }, h("source", { id: "source", type: "audio/mp3" })), h("div", { id: "playlist", class: "playlist-list " + this.playlist }, this.load && h("slot", null))));
    };
    ...
    Object.defineProperty(class_1, "style", {
        get: function () { return PlaylistCss; },
        enumerable: true,
        configurable: true
    });
    return class_1;
