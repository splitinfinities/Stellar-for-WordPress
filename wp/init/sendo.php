...
class SENDO {
	...
	public function set_images($value) {
		...
		$this->set_opengraph_tag('image', $value);
		return $this;
	}
	...
	public function set_canonical($value) {
		...
		$this->set_twitter_card('url', $value)
			->set_opengraph_tag('url', $value)
			->set_opengraph_tag('site_url', $value);
		return $this;
	}
	...
	public function prepare_output() {
		...
		$opengraph_type = (get_field('sdo_facebook_story_type') && get_field('sdo_facebook_story_type') !== 'none') ? get_field('sdo_facebook_story_type') : get_field('sdo_facebook_story_type', 'option');
		...
		if ($opengraph_type !== "none") {
			$this->set_opengraph_tag('type', $opengraph_type)
				->set_opengraph_tag('image', $shareable_image);
		}
	}
