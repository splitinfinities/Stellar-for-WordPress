...
const SkeletonText = class {
    ...
    render() {
        return index.h(index.Host, { style: { '--width': `${this.width}%` } }, index.h("span", null, "\u00A0", index.h("stellar-intersection", { element: this.element, multiple: true, in: this.in.bind(this), out: this.out.bind(this) })));
    }
