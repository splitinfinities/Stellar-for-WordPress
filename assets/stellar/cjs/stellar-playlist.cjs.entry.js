...
class Playlist {
    constructor(hostRef) {
        ...
        this.load_songs = __chunk_1.createEvent(this, "load_songs", 7);
    }
    componentWillLoad() {
    ...
    handleTimeUpdates() {
        this.audio.addEventListener("timeupdate", () => {
            this.currentTime = __chunk_10.asTime(parseFloat(this.audio.currentTime.toString()).toFixed(10));
            this.duration = __chunk_10.asTime(parseFloat(this.audio.duration.toString()).toFixed(10));
