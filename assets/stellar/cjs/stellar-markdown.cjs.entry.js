...
var showdown = __chunk_2.createCommonjsModule(function (module) {
(function(){
/**
...
class Markdown {
    ...
    render() {
        if (this.editable) {
            return __chunk_1.h("stellar-card", null, __chunk_1.h("section", null, __chunk_1.h("copy-wrap", { full: true, class: "wrap" }, __chunk_1.h("div", { innerHTML: this.converted }))), __chunk_1.h("footer", { class: "bg-theme-base0" }, __chunk_1.h("stellar-input", { type: "textarea", default: this.codeString, onChange: (e) => { this.codeString = e.detail; this.convert(); } })));
        }
        else {
            return __chunk_1.h("copy-wrap", { full: true, class: "wrap" }, __chunk_1.h("div", { innerHTML: this.converted }));
        }
    }
