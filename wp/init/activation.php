 ...
 * @return null
 */
function splitinfinities_theme_activation_options_init() {
	register_setting(
		'splitinfinities_activation_options',
		'splitinfinities_theme_activation_options'
	);
}
add_action('admin_init', 'splitinfinities_theme_activation_options_init');
 ...
 */
function splitinfinities_activation_options_page_capability() {
	return 'edit_theme_options';
}
add_filter('option_page_capability_splitinfinities_activation_options', 'splitinfinities_activation_options_page_capability');
 ...
 */
function splitinfinities_theme_activation_options_add_page() {
	$splitinfinities_activation_options = splitinfinities_get_theme_activation_options();
...
add_action('admin_menu', 'splitinfinities_theme_activation_options_add_page', 50);
 ...
 * @return null
 */
function splitinfinities_get_theme_activation_options() {
	return get_option('splitinfinities_theme_activation_options');
}
 ...
 */
function splitinfinities_theme_activation_action() {
	if (!($splitinfinities_theme_activation_options = splitinfinities_get_theme_activation_options())) {
		return;
	}
	...
	if ($splitinfinities_theme_activation_options['change_permalink_structure'] === 'true') {
		$splitinfinities_theme_activation_options['change_permalink_structure'] = false;
	...
	if ($splitinfinities_theme_activation_options['create_navigation_menus'] === 'true') {
		$splitinfinities_theme_activation_options['create_navigation_menus'] = false;
		...
		if ($splitinfinities_nav_theme_mod) {
			set_theme_mod('nav_menu_locations', $splitinfinities_nav_theme_mod);
		}
	}
	...
	update_option('splitinfinities_theme_activation_options', $splitinfinities_theme_activation_options);
}
add_action('admin_init','splitinfinities_theme_activation_action');
 ...
 * @return null
 */
function splitinfinities_deactivation() {
	delete_option('splitinfinities_theme_activation_options');
}
add_action('switch_theme', 'splitinfinities_deactivation');
