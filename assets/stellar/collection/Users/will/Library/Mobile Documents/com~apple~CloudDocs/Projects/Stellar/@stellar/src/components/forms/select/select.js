import { Component, Prop, State, Listen, Watch, Element, Event, Method, h } from '@stencil/core';
...
export class Select {
        ...
        return (h("div", { class: "wrapper" },
            ...
            h("div", { class: "select" },
                ...
                h("button", { type: "button", class: "select-title", onClick: () => this.handleTitleClick(), onFocus: () => this.handleTitleFocus(), onBlur: () => this.handleTitleBlur() },
                    ...
                    this.name && h("input", { type: "text", tabindex: "-1", name: this.name.toString(), required: this.required, value: this.value })),
    ...
    static get properties() { return {
        ...
        "resize": {
            ...
            "mutable": false,
            "complexType": {
                "original": "boolean | \"full\"",
                "resolved": "\"full\" | boolean",
                "references": {}
            },
            "required": false,
            "optional": false,
    ...
    static get methods() { return {
        ...
        "option_elements": {
            "complexType": {
                "signature": "() => Promise<NodeListOf<HTMLStellarItemElement>>",
                "parameters": [],
                "references": {
                    "Promise": {
                        "location": "global"
                ...
                "return": "Promise<NodeListOf<HTMLStellarItemElement>>"
            },
            "docs": {
                "text": "",
                "tags": []
